                ...
                <div class="row justify-content-center">
                    ...
                    <section class="col-lg-12 connectedSortable">
                        ...
                        <form action="{{ route('importKaryawan') }}" method="post" enctype="multipart/form-data">
                            @csrf
                        <div class="modal fade" id="importKaryawan" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        ...
                                        <div class="row">
                                            <table>
                                                ...
                                                <td width="100" class="pl-2">
                                                    <img width="80px" src="{{ asset('adminlte') }}/images/1.png" alt="">
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <a href="{{ route('excelKaryawanAgrilaras') }}" class="btn btn-primary btn-sm"><i class="fa fa-download"></i> DOWNLOAD TEMPLATE</a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="3">
                                            ...
                                            <tr>
                                                <td width="100" class="pl-2">
                                                    <img width="80px" src="{{ asset('adminlte') }}/images/2.png" alt="">
                                                </td>
                                                <td>
