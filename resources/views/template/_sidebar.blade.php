                ...
                <li class="nav-item menu-open">
                    <ul class="nav nav-treeview">
                        @php
                            ...
                            $data = DB::select(DB::raw(" SELECT a.*,b.id_menu FROM menu AS a LEFT JOIN permisi AS b ON b.id_menu = a.id_menu WHERE b.id_user = $id_user AND a.id_departemen = $id_departemen AND a.sub_menu = 0 ORDER BY a.urutan"));
                            $absen = 'book';
                            $karyawan = 'user';
                            $permisi = 'key';
                        @endphp
